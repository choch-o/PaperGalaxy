...
var buttonToGraph = document.getElementById('toGraph');
...
var pageDashboard = document.getElementById('dashboard');
...
buttonToGraph.addEventListener('click', function () {
  pageIndex.classList.add('dn');
  pageDashboard.classList.add('dn');
  pagePaper.classList.remove('dn');
});

buttonToDashboard.addEventListener('click', function () {
  pageIndex.classList.add('dn');
  pageDashboard.classList.remove('dn');
  pagePaper.classList.add('dn');
});

buttonToIndex.addEventListener('click', function () {
  pageIndex.classList.remove('dn');
  pageDashboard.classList.add('dn');
  pagePaper.classList.add('dn');
});
